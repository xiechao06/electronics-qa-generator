...
| `--topologies` | all 22 | Comma-separated topology names to generate |
...
op_amp_inverting    rlc_series_resonance  dc_multisource_mesh  op_amp_inv_input_fb  ac_rl_series  dc_current_divider  dc_nodal_current_source  op_amp_difference  op_amp_noninverting  op_amp_summing
```
...
```mermaid
flowchart TD
    T["📐 Template Library<br/>22 circuit topologies<br/>+ parameter ranges"] --> S["🎲 Sampler<br/>Sample component values,<br/>stimuli, variants<br/>(reproducible by seed)"]
