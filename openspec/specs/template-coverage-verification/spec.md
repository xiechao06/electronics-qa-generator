...
Provide deterministic verification that the question/SVG/netlist triad is
complete and that every answer-relevant fact is visible either in the schematic
image or in the question text.
